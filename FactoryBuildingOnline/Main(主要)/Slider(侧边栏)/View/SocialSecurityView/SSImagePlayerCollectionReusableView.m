//
//  SSImagePlayerCollectionReusableView.m
...
#import "SSImagePlayerCollectionReusableView.h"

@interface SSImagePlayerCollectionReusableView()<ImagePlayerViewDelegate>

@end

@implementation SSImagePlayerCollectionReusableView
