...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    switch (indexPath.row) {
        ...
        case 3:
        {   // 社保
            SocialSecurityTabBarViewController *ssTabBarVC = [SocialSecurityTabBarViewController new];
            [self presentViewController:ssTabBarVC animated:YES completion:nil ];
        }
            break;
...
- (UIImageView *)bgImageView {
    if (!_bgImageView) {
        ...
        _bgImageView.image = [UIImage imageNamed:@"slider_bg"];
