...
@implementation HomeFactoryModel
 ...
 *  @return BOOL
 */
+ (BOOL)insertFactoryModel:(HomeFactoryModel *)model {
    
    BOOL flag = NO;
    
    FMDatabase *db = [HomeFactoryModel createDatabase];
    //
    if ([db open]) {
